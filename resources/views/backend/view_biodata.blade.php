        ...
        <div class="ds-public-biodata-container">
            <div class="container ds-container">
                <div class="dsb-content-inner">
                    ...
                    <div class="row dsdb-content">
                        <div class="row preview-bio">
                            <div class="col-lg-6 col-md-6 col-12">
                                <h2 class="preview-bio-header">বায়োডাটা</h2>
                            </div>
                        </div>
                        {{-- General Info--}}
                        ...
                        <div class="col-12 col-lg-8">
                            ...
                            {{-- end --}}
                                ...
                                <div class="add_biodata_submit buttons "
                                    ...
                                    {{-- reject --}}
                                    <form action="{{ route('biodata.reject', $biodata->id) }}" method="POST">
                                        @csrf
                                        <button
                                            type="submit"
                                            class="nextBtn ds-button reject_biodata"
                                        >
                                            Reject
                                        </button>
                                    </form>
                                    {{-- // --}}
                                    <form action="{{ route('biodata.accept', $biodata->id) }}" method="POST">
                                        @csrf
                                        <button
                                            type="submit"
                                            class="nextBtn ds-button accept_biodata"
                                        >
                                            Approve
                                        </button>
                                    </form>
