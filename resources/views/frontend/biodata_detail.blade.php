                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="dsb-each-bio-general">
                             ...
                             <!-- {{-- Start Share Button  --}} -->
                                <div class="dsb-each-bio-link-generator">
                                    <button id="openShare" class="dsb--bio-share-btn ds-button-border"><img src="{{ asset('frontend') }}/uploads/share-color2.svg" alt="">Share</button>
                                    <div class="dsb-share-modal" id="shareModal">
                                        <div class="dsb-share-content">
                                            <span class="dsb-share-close-btn" id="closeShare">&times;</span>
                                            <h2>Share this link</h2>
                                            <div class="dsb-share-icons">
                                                <a href="#" id="facebookShare" class="dsb-share-icon fb"><img src="{{ asset('frontend') }}/uploads/Facebook.svg" alt=""></a>
                                                <a href="#" id="whatsappShare" class="dsb-share-icon wa"><img src="{{ asset('frontend') }}/uploads/Whatsapp.svg" alt=""></a>
                                                <a href="#" id="twitterShare" class="dsb-share-icon tw"><img src="{{ asset('frontend') }}/uploads/Twitter.svg" alt=""></a>
                                                <a href="#" id="emailShare" class="dsb-share-icon em"><img src="{{ asset('frontend') }}/uploads/Mail-Share.svg" alt=""></a>
                                            </div>
                                            <div class="dsb-share-copy-box">
                                                <input type="text" id="shareLink" class="dsb-bio-share-link" value="https://deendarsangee.com/share-link" readonly>
                                                <button id="copyLink" class="copylink-btn">Copy</button>
                                            </div>
                                        </div>
                                    </div>
                                    <a href="#" class=" dsb-each-bio-link-content dsb-each-biodata-favourite ds-button"><img src="{{ asset('frontend') }}/uploads/love.svg" alt="">Add to wishlist</a>
                                </div>
                            <!-- {{-- End Share Button --}} -->
                        </div>
                        ...
                        <div class="col-12 col-lg-8">
                            ...
                            @else
                                                <!-- PROPOSAL CONTACT PART START-->
                     <div class="proposal-contact-container">
  <div class="proposal-contact-btn-box">
    <button class="proposal-send-btn active">প্রস্তাব</button>
    <button class="want-contact-btn">যোগাযোগ</button>
  </div>

  <div class="proposal-contact-content-box">
    <div class="send-proposal-content content-box active">
      <h3>প্রস্তাব পাঠাতে আগ্রহী?</h3>
      <p> এই বায়োডাটায় প্রাথমিক প্রস্তাব পাঠাতে আপনার ১টি কানেক্ট খরচ হবে</p>
      <button class="interested-btn">আগ্রহী <span><img src="{{ asset('frontend') }}/uploads/Send Proposal.svg" alt=""></span></button>
    </div>

    <div class="want-contact-content content-box">
        <h3>যোগাযোগ তথ্য নিতে আগ্রহী?</h3>
      <p>এই বায়োডাটার যোগাযোগ তথ্য দেখতে আপনার ২টি কানেক্ট খরচ হবে।</p>
      <button class="want-contact-btn"><span><img src="{{ asset('frontend') }}/uploads/Contact-Info-white.svg" alt=""></span>যোগাযোগ তথ্য দেখুন </button>
    </div>
  </div>
</div>
<div class="how-proposal-contact-box">
    <a href="#" class="how-proposal-contact-btn"><span><img src="{{ asset('frontend') }}/uploads/Youtube-Social.svg" alt=""></span>যেভাবে প্রস্তাব ও যোগাযোগ কাজ করে</a>
</div>
<!-- PROPOSAL CONTACT PART END-->
                                ...
                                {{-- <div class="dsb-each-bio-field">
                                    <div class="dsb-ebf-inner">
                                        ...
                                        <div class="dsb-ebf-content">
                                            ...
                                            <div class="dsb-contact-info-container">
                                                <a href="{{ route('checkout') }}" class="contact-info-btn ds-button">যোগাযোগ তথ্য দেখুন</a>
                                                <div class="dsb-contact-info-hider">
                                                    <img src="{{ asset('frontend') }}/uploads/Contact-Info-hider.svg" alt="">
                                                </div>
                                                <div class="dsb-contact-info-content">
                                                    <div class="dsb-ebf-item">
                                                        <label for="">পাত্রের নাম</label>
