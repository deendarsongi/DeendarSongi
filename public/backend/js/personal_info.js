...
$(function () {
    var originalData = $('#parsonal-information').serialize();

    $('#parsonal-information').submit(function (e) {
        e.preventDefault();
                ...
                if (response.action === 'update') {
                    if (dataChanged) {
                        Swal.fire({
                            ...
                            text: "ব্যক্তিগত তথ্য আপডেট করতে যাচ্ছেন!",
                            icon: 'warning',
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.action === 'update' || response.action === 'insert') {
                    ...
                    $('#parsonal-alert').fadeIn();
                    setTimeout(function () {
                        $('#parsonal-alert').fadeOut();
                    }
                    , 5000);
                    goToStep(5);
